...
const SingleComic = (props) => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
          try {
            const { data } = await axios.get("/comics/" + props.match.params.id);
            dispatch(actions.setPage("SingleComic/" + props.match.params.id, data));
          } catch (e) {
            console.log(e);
          }
        }
      ...
      let index = copyState.findIndex((x) => x.pageTerm === "SingleComic/" + props.match.params.id);
